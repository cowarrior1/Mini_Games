...
public class buttonsToDisable : MonoBehaviour {
	...
	public void CloseButtonClickHandler()
	{
		...
		if (this.gameObject.GetComponent<btnActionsChallengeScreen>() != null)
			this.gameObject.GetComponent<btnActionsChallengeScreen>().btnCloseClicked();

		if (this.gameObject.GetComponent<btnActionsPuzzlePositiveFeedback>() != null)
			this.gameObject.GetComponent<btnActionsPuzzlePositiveFeedback>().btnCloseClicked();
